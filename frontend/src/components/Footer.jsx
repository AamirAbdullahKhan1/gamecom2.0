...
export default function Footer() {
  return (
    <footer className="mt-20 border-t border-gray-200/60 dark:border-gray-700/60 bg-white/60 dark:bg-gray-900/60 backdrop-blur">
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a href="#" aria-label="Instagram" className="p-2 rounded-lg border border-gray-200/60 dark:border-gray-700/60 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="#" aria-label="Twitter" className="p-2 rounded-lg border border-gray-200/60 dark:border-gray-700/60 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="#" aria-label="GitHub" className="p-2 rounded-lg border border-gray-200/60 dark:border-gray-700/60 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                <Github className="w-5 h-5" />
              </a>
              <a href="mailto:hello@gamecom.club" aria-label="Email" className="p-2 rounded-lg border border-gray-200/60 dark:border-gray-700/60 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
