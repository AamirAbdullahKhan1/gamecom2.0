      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {galleryImages.map((image, index) => (
            <Card
              key={index}
              className="group overflow-hidden card-light dark:card-dark hover:bg-white/20 dark:hover:bg-white/10 transition-all duration-500 hover:scale-105 cursor-pointer hover:shadow-xl hover:shadow-purple-500/10 dark:hover:shadow-purple-400/20 animate-fade-in-up"
              style={{
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <Card className="p-6 bg-gradient-to-br from-purple-500/20 to-pink-500/20 dark:from-purple-500/10 dark:to-pink-500/10 backdrop-blur-xl border border-purple-200 dark:border-white/10 text-center hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20">
            <div className="text-3xl font-bold text-light-primary dark:text-dark-primary mb-2">10+</div>
            <div className="text-light-secondary dark:text-dark-secondary">Events Hosted</div>
          </Card>
          <Card className="p-6 bg-gradient-to-br from-blue-500/20 to-purple-500/20 dark:from-blue-500/10 dark:to-purple-500/10 backdrop-blur-xl border border-blue-200 dark:border-white/10 text-center hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20">
          ...
          <Card className="p-6 bg-gradient-to-br from-green-500/20 to-blue-500/20 dark:from-green-500/10 dark:to-blue-500/10 backdrop-blur-xl border border-green-200 dark:border-white/10 text-center hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/20">
            <div className="text-3xl font-bold text-light-primary dark:text-dark-primary mb-2">100+</div>
            <div className="text-light-secondary dark:text-dark-secondary">Memories Created</div>
          </Card>
          <Card className="p-6 bg-gradient-to-br from-pink-500/20 to-purple-500/20 dark:from-pink-500/10 dark:to-purple-500/10 backdrop-blur-xl border border-pink-200 dark:border-white/10 text-center hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/20">
            <div className="text-3xl font-bold text-light-primary dark:text-dark-primary mb-2">∞</div>
            <div className="text-light-secondary dark:text-dark-secondary">Fun Moments</div>
          </Card>
        </div>
      </div>
