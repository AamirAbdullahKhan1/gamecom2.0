  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        >
          <Button className="gradient-primary-light dark:gradient-primary-dark hover:from-blue-700 hover:to-purple-700 dark:hover:from-blue-600 dark:hover:to-purple-600 text-white px-10 py-5 text-xl font-semibold rounded-2xl shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105 group">
          ...
          <Button
            variant="outline"
            className="btn-outline-light dark:btn-outline-dark px-10 py-5 text-xl font-semibold rounded-2xl glass-light dark:glass-dark transition-all duration-300 hover:scale-105 group"
          >
